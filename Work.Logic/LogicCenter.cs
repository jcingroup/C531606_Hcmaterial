...
namespace ProcCore.Business.LogicConect
{
    ...
    public enum ParmDefine
    {
        ...
        url_1_jp, url_2_jp, url_3_jp, url_4_jp, url_5_jp
    }
    #endregion
    ...
    public class LogicCenter
    {
        ...
        private const string DatabaseName = "C53A0_Hcmaterial";
        ...
        public static C53A0_HcmaterialEntities getDB0
        {
            get
            {
                return new C53A0_HcmaterialEntities(db0_connectionstring);
            }
        }
